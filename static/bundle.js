...
var app = (function () {
    ...
    const file$3 = "src/layouts/main/layout-components/top-bar/TopBarSearch.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$3, 4, 8, 216);
    			attr_dev(div0, "class", "input-group-text");
    			add_location(div0, file$3, 3, 6, 177);
    			attr_dev(div1, "class", "input-group-prepend");
    			add_location(div1, file$3, 2, 4, 137);
    			...
    			add_location(input, file$3, 7, 4, 274);
    			attr_dev(div2, "class", "input-group input-group-seamless ml-3");
    			add_location(div2, file$3, 1, 2, 81);
    ...
    /* src/layouts/main/layout-components/top-bar/TopBarNotifications.svelte generated by Svelte v3.20.1 */

    const file$4 = "src/layouts/main/layout-components/top-bar/TopBarNotifications.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t7 = space();
    			p0 = element("p");
    			t8 = text("Your website’s active users count increased by ");
    			span2 = element("span");
    			span2.textContent = "28%";
    			t10 = text(" in the last week. Great job!");
    			t11 = space();
    			a2 = element("a");
    			div5 = element("div");
    			div4 = element("div");
    			...
    			t15 = space();
    			p1 = element("p");
    			t16 = text("Last week your store’s sales count decreased by ");
    			span4 = element("span");
    			span4.textContent = "5.52%";
    			t18 = text(". It could have been worse!");
    			t19 = space();
    			a3 = element("a");
    			a3.textContent = "View all Notifications";
    			attr_dev(i0, "class", "material-icons");
    			add_location(i0, file$4, 10, 6, 300);
    			attr_dev(span0, "class", "badge badge-pill badge-danger");
    			add_location(span0, file$4, 11, 6, 338);
    			attr_dev(div0, "class", "nav-link-icon__wrapper");
    			add_location(div0, file$4, 9, 4, 257);
    			...
    			add_location(a0, file$4, 1, 2, 60);
    			attr_dev(i1, "class", "material-icons");
    			add_location(i1, file$4, 18, 10, 631);
    			attr_dev(div1, "class", "notification__icon");
    			add_location(div1, file$4, 17, 8, 588);
    			attr_dev(div2, "class", "notification__icon-wrapper");
    			add_location(div2, file$4, 16, 6, 539);
    			attr_dev(span1, "class", "notification__category");
    			add_location(span1, file$4, 22, 8, 741);
    			attr_dev(span2, "class", "text-success text-semibold");
    			add_location(span2, file$4, 23, 58, 853);
    			add_location(p0, file$4, 23, 8, 803);
    			attr_dev(div3, "class", "notification__content");
    			add_location(div3, file$4, 21, 6, 697);
    			attr_dev(a1, "class", "dropdown-item");
    			attr_dev(a1, "href", "/");
    			add_location(a1, file$4, 15, 4, 498);
    			attr_dev(i2, "class", "material-icons");
    			add_location(i2, file$4, 29, 10, 1097);
    			attr_dev(div4, "class", "notification__icon");
    			add_location(div4, file$4, 28, 8, 1054);
    			attr_dev(div5, "class", "notification__icon-wrapper");
    			add_location(div5, file$4, 27, 6, 1005);
    			attr_dev(span3, "class", "notification__category");
    			add_location(span3, file$4, 33, 8, 1207);
    			attr_dev(span4, "class", "text-danger text-semibold");
    			add_location(span4, file$4, 34, 59, 1316);
    			add_location(p1, file$4, 34, 8, 1265);
    			attr_dev(div6, "class", "notification__content");
    			add_location(div6, file$4, 32, 6, 1163);
    			attr_dev(a2, "class", "dropdown-item");
    			attr_dev(a2, "href", "/");
    			add_location(a2, file$4, 26, 4, 964);
    			attr_dev(a3, "class", "dropdown-item notification__all text-center");
    			attr_dev(a3, "href", "/");
    			add_location(a3, file$4, 37, 4, 1426);
    			attr_dev(div7, "class", "dropdown-menu dropdown-menu-small");
    			attr_dev(div7, "aria-labelledby", "dropdownMenuLink");
    			add_location(div7, file$4, 14, 2, 411);
    			attr_dev(li, "class", "nav-item border-right dropdown notifications");
    ...
    function instance$5($$self, $$props) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<TopBarNotifications> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("TopBarNotifications", $$slots, []);
    	return [];
    }

    class TopBarNotifications extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    const file$5 = "src/layouts/main/layout-components/top-bar/TopBarUserDropdown.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$5, 13, 4, 307);
    			attr_dev(span, "class", "d-none d-md-inline-block");
    			add_location(span, file$5, 16, 26, 423);
    			attr_dev(a, "href", "/");
    			...
    			add_location(a, file$5, 5, 2, 80);
    			attr_dev(li, "class", "nav-item dropdown");
    			add_location(li, file$5, 4, 0, 47);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$6 = "src/layouts/main/layout-components/top-bar/TopBar.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	const topbaruserdropdown = new TopBarUserDropdown({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			create_component(topbaruserdropdown.$$.fragment);
    			t2 = space();
    			nav0 = element("nav");
    			a = element("a");
    			i = element("i");
    			...
    			add_location(ul, file$6, 9, 4, 345);
    			attr_dev(i, "class", "material-icons");
    			add_location(i, file$6, 21, 8, 759);
    			attr_dev(a, "href", "/");
    			attr_dev(a, "class", "nav-link nav-link-icon toggle-sidebar d-md-inline d-lg-none text-center border-left");
    			attr_dev(a, "data-toggle", "collapse");
    			attr_dev(a, "data-target", ".header-navbar");
    			attr_dev(a, "aria-expanded", "false");
    			attr_dev(a, "aria-controls", "header-navbar");
    			add_location(a, file$6, 14, 6, 488);
    			attr_dev(nav0, "class", "nav");
    			add_location(nav0, file$6, 13, 4, 464);
    			attr_dev(nav1, "class", "navbar align-items-stretch navbar-light flex-md-nowrap p-0");
    			add_location(nav1, file$6, 7, 2, 247);
    			attr_dev(div, "class", "main-navbar sticky-top bg-white");
    			add_location(div, file$6, 6, 0, 199);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, nav1);
    			mount_component(topbarsearch, nav1, null);
    			append_dev(nav1, t0);
    			append_dev(nav1, ul);
    			mount_component(topbarnotifications, ul, null);
    			append_dev(ul, t1);
    			mount_component(topbaruserdropdown, ul, null);
    			append_dev(nav1, t2);
    		...
    		i: function intro(local) {
    			...
    			transition_in(topbaruserdropdown.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(topbarsearch.$$.fragment, local);
    			transition_out(topbarnotifications.$$.fragment, local);
    			transition_out(topbaruserdropdown.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    			...
    			destroy_component(topbaruserdropdown);
    		}
    	};
    ...
    const file$7 = "src/layouts/main/layout-components/logo/Logo.svelte";
    ...
    const file$8 = "src/layouts/main/layout-components/side-nav/SideNavItem.svelte";
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(/*text*/ ctx[2]);
    			attr_dev(i, "class", "material-icons");
    			add_location(i, file$8, 14, 4, 289);
    			add_location(span, file$8, 15, 4, 330);
    			attr_dev(a, "class", "nav-link active");
    			attr_dev(a, "href", /*href*/ ctx[0]);
    			add_location(a, file$8, 9, 2, 205);
    			attr_dev(li, "class", "nav-item");
    			add_location(li, file$8, 8, 0, 181);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class SideNavItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$9, create_fragment$9, safe_not_equal, { href: 0, icon: 1, text: 2 });
    ...
    const file$9 = "src/layouts/main/layout-components/side-nav/SideNavSearch.svelte";
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			input = element("input");
    			attr_dev(i, "class", "fas fa-search");
    			add_location(i, file$9, 4, 8, 233);
    			attr_dev(div0, "class", "input-group-text");
    			add_location(div0, file$9, 3, 6, 194);
    			attr_dev(div1, "class", "input-group-prepend");
    			add_location(div1, file$9, 2, 4, 154);
    			attr_dev(input, "class", "navbar-search form-control");
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Search for something...");
    			attr_dev(input, "aria-label", "Search");
    			add_location(input, file$9, 7, 4, 291);
    			attr_dev(div2, "class", "input-group input-group-seamless ml-3");
    			add_location(div2, file$9, 1, 2, 98);
    			attr_dev(form, "action", "#");
    			attr_dev(form, "class", "main-sidebar__search w-100 border-right d-sm-flex d-md-none d-lg-none");
    			add_location(form, file$9, 0, 0, 0);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$a = "src/layouts/main/layout-components/side-nav/SideNav.svelte";
    ...
    function create_each_block(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(23:6) {#each modules as {id, ...props}",
    		ctx
    	});
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$a, 21, 4, 812);
    			attr_dev(div, "class", "nav-wrapper");
    			add_location(div, file$a, 20, 2, 782);
    			attr_dev(aside, "class", "main-sidebar col-12 col-md-3 col-lg-2 px-0");
    			add_location(aside, file$a, 16, 0, 689);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(aside, t0);
    			mount_component(sidenavsearch, aside, null);
    			append_dev(aside, t1);
    ...
    const file$b = "src/layouts/main/layout-components/footer/Footer.svelte";
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$b, 11, 0, 146);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$c = "src/layouts/main/MainLayout.svelte";
    ...
    function fallback_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$c, 26, 6, 637);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$c, 23, 2, 521);
    			attr_dev(div, "class", "main-layout row svelte-2vcaxc");
    			add_location(div, file$c, 20, 0, 475);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
